...
checkpointLocation = "s3://stream-checkpoint-bucket1/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://redshift-cluster-dev.cf73wjorgr6f.us-east-1.redshift.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://temp-gds-files1/streaming-temp/"
